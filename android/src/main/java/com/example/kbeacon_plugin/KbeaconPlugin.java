        ...
        espProvisionManager.searchBleEspDevices(prefix, new BleScanListener() {
            ...
            public void onPeripheralFound(BluetoothDevice device, ScanResult scanResult) {
                if (device != null && scanResult != null) {
                    ...
                    String serviceUuid = scanResult.getScanRecord().getServiceUuids().get(0).toString();
                    bleDevices.put(deviceName, device);
                    bleDeviceServiceUuids.put(deviceName, serviceUuid);
                    if (bleScanEventSink != null) {
                        bleScanEventSink.success(deviceName);
                    }
                }
            }
